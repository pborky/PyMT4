...
namespace PyMT4
{
    ...
    namespace Command
    {
        ...
        bool IsConnected(const bool& flow_return_value)
        {
            return DispatchFunction<bool, const bool>()(CmdId_IsConnected, flow_return_value);
        }

        int32_t Is_Server_Online(const int32_t &server_online_return_value, const bool& flow_return_value)
        {
            return DispatchFunction<int32_t, const int32_t, const bool>()(CmdId_Is_Server_Online, server_online_return_value, flow_return_value);
        }

        bool Is_Server_Asleep(const bool& flow_return_value)
        {
            return DispatchFunction<bool, const bool>()(CmdId_Is_Server_Asleep, flow_return_value);
        }
        ...
        {
            std::string resultString = DispatchFunction<std::string>()(PyMT4::CmdId_AccountCompany);
            return resultString.c_str();
        }

        std::string AccountCurrency()
        {
            std::string resultString = DispatchFunction<std::string>()(PyMT4::CmdId_AccountCurrency);
            return resultString.c_str();
        }
        ...
        {
            std::string resultString = DispatchFunction<std::string>()(PyMT4::CmdId_AccountName);
            return resultString.c_str();
        }
        ...
        {
            std::string resultString = DispatchFunction<std::string>()(PyMT4::CmdId_AccountServer);
            return resultString.c_str();
        }
        ...
        {return DispatchFunction<int32_t,const std::string,const Datetime,const bool>()(CmdId_iBarShift,symbol,datetime,exact);}
        ...
        {
            std::string resultString = DispatchFunction<std::string,const int32_t>()(CmdId_OrderComment,ticket);
            return resultString.c_str();
        }
        ...
        {
            std::string resultString = DispatchFunction<std::string,const int32_t>()(CmdId_OrderSymbol,ticket);
            return resultString.c_str();
        }
        ...
        {
            std::string resultString = DispatchFunction<std::string>()(CmdId_TerminalCompany);
            return resultString.c_str();
        }

        std::string TerminalName()
        {
            std::string resultString = DispatchFunction<std::string>()(CmdId_TerminalName);
            return resultString.c_str();
        }
        ...
        {
            std::string resultString = DispatchFunction<std::string>()(CmdId_TerminalPath);
            return resultString.c_str();
        }
...
//#endif
        ...
        {
            std::string resultString = DispatchFunction<std::string>()(CmdId_Symbol);
            return resultString.c_str();
        }
