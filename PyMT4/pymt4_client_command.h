...
namespace PyMT4
{
    ...
    {
        // System Commands
        bool    IsConnected(const bool& flow_return_value = false);
        int32_t Is_Server_Online(const int32_t &server_online_return_value, const bool& flow_return_value = false);
        bool    Is_Server_Asleep(const bool& flow_return_value = false);
